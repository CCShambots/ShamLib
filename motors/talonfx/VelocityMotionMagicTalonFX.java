...
public class VelocityMotionMagicTalonFX extends MotionMagicTalonFX {
    ...
    public VelocityMotionMagicTalonFX(int deviceNumber, String canbus, PIDSVGains gains, double inputToOutputRatio, double maxAccel, double jerk) {
        super(deviceNumber, canbus, gains, inputToOutputRatio, 10000, maxAccel, jerk);
    }

    public VelocityMotionMagicTalonFX(int deviceNumber, String canbus, PIDSVGains gains, double inputToOutputRatio, double maxAccel) {
    ...
    public VelocityMotionMagicTalonFX(int deviceNumber, PIDSVGains gains, double inputToOutputRatio, double maxAccel) {
        super(deviceNumber, gains, inputToOutputRatio, 10000, maxAccel);
    }

    public VelocityMotionMagicTalonFX(int deviceNumber, PIDSVGains gains, double inputToOutputRatio, double maxAccel, double jerk) {
        super(deviceNumber, gains, inputToOutputRatio, 10000, maxAccel, jerk);
    }

    public VelocityMotionMagicTalonFX(int deviceNumber, String canbus, PIDSVGains gains, double inputToOutputRatio) {
