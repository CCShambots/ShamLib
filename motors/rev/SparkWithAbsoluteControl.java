...
public class SparkWithAbsoluteControl extends CANSparkMax {
   ...
   * @param encoderOffset the offset of the absolute encoder from the desired zero position (in
   *     radians)
   * @param inputToOutputRatio the gear ratio of the motor, such that multiplying position of the
   *     relative encoder (in rotation) to output units
   */
  public SparkWithAbsoluteControl(
      int deviceId,
      MotorType type,
      SmartMotionValues gains,
