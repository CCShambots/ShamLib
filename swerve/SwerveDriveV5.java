...
public class SwerveDriveV5 {

    protected final List<SwerveModuleV5> modules;
     ...
     */
    public SwerveDriveV5(int pigeon2ID,
        ...
        for(int i = 0; i<moduleInfos.length; i++) {
            ...
            modules.add(new SwerveModuleV5("Module-" + numModules, moduleCanbus, m.turnMotorID, m.driveMotorID,
    ...
    private Pose2d calculateModulePose(SwerveModuleV5 module, Pose2d robotPose) {
    ...
    public void setAllModules(SwerveModuleState state) {
        for(SwerveModuleV5 module : modules) {
    ...
    public void stopModules() {
        modules.forEach(SwerveModuleV5::stop);
    }
