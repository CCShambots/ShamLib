...
public class SwerveModuleIOSim extends SwerveModuleIOReal {
    ...
    public SwerveModuleIOSim(String canbus, ModuleInfo mI, PIDSVGains driveGains, PIDSVGains turnGains,
            double maxTurnVelo, double maxTurnAccel, CurrentLimitsConfigs currentLimit) {
        super(canbus, mI, driveGains, turnGains, maxTurnVelo, maxTurnAccel, currentLimit);

        PhysicsSim.getInstance().addTalonFX(turnMotor, 0.001);
        PhysicsSim.getInstance().addTalonFX(driveMotor, 0.001);
    }
