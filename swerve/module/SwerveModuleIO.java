...
public interface SwerveModuleIO {
    ...
    public default Command calculateTurnKV(double kS, Trigger increment, BooleanSupplier interrupt) {return new InstantCommand();}
    public default Command calculateDriveKV(double kS, Trigger increment, Trigger invert, BooleanSupplier interrupt, boolean telemetry) {return new InstantCommand();}
