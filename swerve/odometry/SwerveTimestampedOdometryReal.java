...
public class SwerveTimestampedOdometryReal implements SwerveOdometry  {
    ...
    public SwerveTimestampedOdometryReal(TimestampedPoseEstimator estimator, SwerveDriveKinematics kinematics, List<SwerveModule> modules, Supplier<Rotation2d> gyroAngle) {
